...
const Detail = () => {
  let dispatch= useDispatch(); //este componente va a mandar acciones
  let { id }= useParams();
  ...
  useEffect(() => {
    ...
    return ()=> {
      dispatch(resetDetail())  //esta accion evita guardar los ultimos detalles vistos, para que asi cuando veas un nuevo dogDetail no veas el dog visto anteriormente
    }
  }, [id, dispatch])

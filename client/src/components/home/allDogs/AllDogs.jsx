...
//Esta funcion tiene toda la logig del /home

const AllDogs = () => {

  //Cree todas las consts que necesito usar en esta funcion
  ...
  const [setTemperament]= useState('all')
  const [dogsPerPage] = useState(8) //this number 8 is the amount of dogs I want to show per page
  ...
  //Esto es para mostrar los temperaments de forma ordenada
  ...
  //Quiero que todo lo que sigue suceda cuando mi componente se monte
  useEffect(()=> {
    setTimeout(() => {
      setLoad(false)
    }, 2000);
  ...
  //Toda la logic está completada, ahora retorno todo lo que quiero renderizar
